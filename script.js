...
switch (weatherConditions) {
  ...
  case 'Mist':
    ...
    break;
  case 'Snow':
    body.style.backgroundImage = "url('https://img.freepik.com/free-vector/christmas-snow-overlay_1048-11413.jpg?size=626&ext=jpg&ga=GA1.2.414568554.1681730826&semt=sph')";
    break;
  case 'Clear':
